        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              disabled={page === 0}
              className="p-3 bg-white rounded-xl border border-slate-100 shadow-sm disabled:opacity-30 hover:bg-slate-50 transition-colors"
            >
              <ChevronLeft className="h-5 w-5" />
            </button>
            <span className="text-[10px] font-black uppercase px-4">Página {page + 1}</span>
            <button 
