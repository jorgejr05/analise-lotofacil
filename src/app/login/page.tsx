      ...
      <div className="w-full max-w-md space-y-8">
        <header className="text-center space-y-2">
          <div className="flex justify-center mb-6">
            <div className="bg-indigo-600 p-4 rounded-tr-3xl rounded-bl-3xl shadow-2xl shadow-indigo-200 rotate-3 hover:rotate-0 transition-transform duration-500">
        ...
        <Card className="border-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.1)] rounded-tl-[4rem] rounded-br-[4rem] bg-white overflow-hidden relative">
          <div className="absolute top-0 right-0 p-6 opacity-[0.03] pointer-events-none">
            <ShieldCheck className="h-32 w-32 text-slate-900" />
          </div>
          
          <CardHeader className="pt-10 pb-2 px-8">
            <CardTitle className="text-xs font-black uppercase tracking-widest text-slate-500 italic flex items-center gap-2">
              <div className="w-8 h-[2px] bg-indigo-600" /> Acesso Seguro
            </CardTitle>
          </CardHeader>
          ...
          <CardContent className="p-8 pt-2">
            <Auth
              ...
              appearance={{ 
                ...
                className: {
                  button: 'font-black uppercase italic tracking-widest h-12 transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-indigo-100',
                  input: 'border-2 border-slate-100 focus:border-indigo-600 transition-colors h-12 font-medium',
                  label: 'font-black uppercase text-[9px] tracking-widest text-slate-400 mb-2',
                }
              }}
              providers={[]}
              localization={{
                variables: {
                  ...
                  sign_up: {
                    ...
                    loading_button_label: 'Registrando no Sistema...',
                    link_text: 'Já possui registro? Entre aqui',
                  },
                  forgotten_password: {
                    email_label: 'E-mail de Recuperação',
                    button_label: 'Resetar Chave de Acesso',
        ...
        <footer className="pt-4 opacity-40">
          <MadeWithDyad />
        </footer>
      </div>
    </div>
